...
export const projectQuestions: Record<string, QuestionConfig[]> = {
  [PROJECT_TYPES.FRONTEND]: [
    ...
    },
    {
      ...
      type: InputType.SELECT,
      options: [
        { value: "tailwind", label: "Tailwind CSS", icon: RiTailwindCssFill },
    ...
    },
    {
      ...
      type: InputType.SELECT,
      options: [
        { value: "npm", label: "npm", icon: FaNpm },
        { value: "yarn", label: "Yarn", icon: FaYarn },
        { value: "pnpm", label: "pnpm", icon: SiPnpm },
        { value: "bun", label: "Bun", icon: BiUnlink },
      ],
      required: true,
    },
    {
    ...
    },
    {
      ...
      type: InputType.SELECT,
      options: [
        { value: "mui", label: "Material-UI", icon: GiMaterialsScience },
  ...
  [PROJECT_TYPES.BACKEND]: [
    ...
    },
    {
      ...
      options: [
        ...
        { value: "flask", label: "Flask", icon: FaFlask },
    ...
    },
    {
      ...
      type: InputType.SELECT,
      options: [
        { value: "jwt", label: "JWT", icon: FaJarWheat },
        { value: "session", label: "Session-based", icon: SiSession },
        { value: "oauth", label: "OAuth 2.0", icon: SiAegisauthenticator },
        { value: "none", label: "None" },
      ],
      required: true,
    },
  ...
  [PROJECT_TYPES.FULLSTACK]: [
    ...
    },
    {
      ...
      type: InputType.SELECT,
      options: [
        { value: "next-auth", label: "NextAuth.js", icon: FaDiagramNext },
        ...
        { value: "custom", label: "Custom Implementation", icon: BiCustomize },
      ],
      required: true,
    },
    {
